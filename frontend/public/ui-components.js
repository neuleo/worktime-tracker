        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border">
                ...
                <form onsubmit="handleSettingsSubmit(event)" class="p-6 space-y-4">
                    ...
                    ${isOwnSettings && activeUser === 'leon' ? `
                    <div class="pt-4">
                        <label for="setting-debug-logging" class="flex items-center justify-between cursor-pointer">
                            <span class="font-medium text-gray-700 pr-4">Debug Logging aktivieren</span>
                            <div class="relative">
                                <input type="checkbox" id="setting-debug-logging" class="sr-only peer" ${settings.debug_logging_enabled ? 'checked' : ''}>
                                <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                            </div>
                        </label>
                    </div>
